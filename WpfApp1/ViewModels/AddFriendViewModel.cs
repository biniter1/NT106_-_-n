...
using WpfApp1.Views; // Add namespace for CustomMessageBox
    ...
    public partial class AddFriendViewModel : ObservableObject
    {
        ...
        private async Task SearchAsync()
        {
            ...
            try
            {
                ...
                {
                    CustomMessageBox.Show("Nguoi dung khong ton tai", "Thông báo", CustomMessageBoxWindow.MessageButtons.OK, CustomMessageBoxWindow.MessageIcon.Warning);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task AddFriendAsync(UserSearchResult user)
        {
            ...
            if (checkFriend)
            {
                CustomMessageBox.Show("Bạn đã là bạn với người này rồi", "Thông báo", CustomMessageBoxWindow.MessageButtons.OK, CustomMessageBoxWindow.MessageIcon.Information);
